...
Monster.monsters.push(new Monster("darkclan-kaelin-healer", "Dark Healer", 102, "darkclan_healer", 105, null))
Monster.monsters.push(new Monster("darkclan-kaelin-blader", "Apprentice Blader", 102, "darkclan_blader", 115, null))
Monster.monsters.push(new Monster("darkclan-kaelin-bookmaster", "Book Master", 102, "darkclan_bookmaster", 120, null))
...
Monster.monsters.push(new Monster("pande-kaelin-knight", "Light Crawler", 105, "pande_knight", 330, null))
Monster.monsters.push(new Monster("pande-kaelin-mage", "Dead Lich", 105, "pande_mage", 334, null))
Monster.monsters.push(new Monster("pande-kaelin-reaper", "Soul Reaper", 105, "pande_reaper", 339, null))
Monster.monsters.push(new Monster("pande-kaelin-skull", "Awakened Angel", 105, "pande_skull", 346, null))
Monster.monsters.push(new Monster("pande-kaelin-warrior", "Knight Crawler", 105, "pande_warrior", 350, null))
Monster.monsters.push(new Monster("pande-kaelin-yoggoth", "Yoggoth, Initial Form", 105, "pande_yoggoth", 625, null))
